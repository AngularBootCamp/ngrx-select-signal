# Angular Boot Camp example: ngrx-select-signal
...
**[StackBlitz for ngrx-select-signal](https://stackblitz.io/github/AngularBootCamp/ngrx-select-signal)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/ngrx-select-signal.git
cd ngrx-select-signal
npm install
npm start
```
